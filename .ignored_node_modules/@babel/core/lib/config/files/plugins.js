...
const resolvePlugin = (exports.resolvePlugin = resolveStandardizedName.bind(
  null,
  'plugin',
))
const resolvePreset = (exports.resolvePreset = resolveStandardizedName.bind(
  null,
  'preset',
))
function* loadPlugin(name, dirname) {
  const { filepath, loader } = resolvePlugin(
    name,
    dirname,
    yield* (0, _async.isAsync)(),
  )
...
function* loadPreset(name, dirname) {
  const { filepath, loader } = resolvePreset(
    name,
    dirname,
    yield* (0, _async.isAsync)(),
  )
