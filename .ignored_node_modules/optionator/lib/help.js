...
;(function () {
  ...
  wordwrap = function (a, b) {
    ...
    ;(ref$ =
      b === undefined ? ['', a - 1] : [repeatString$(' ', a), b - a - 1]),
      (indent = ref$[0]),
      (width = ref$[1])
  ...
  getPreText = function (option, arg$, maxWidth) {
    ...
    if (
      maxWidth != null &&
      !option.boolean &&
      initialIndent + namesStringLen + typeSeparatorStringLen + type.length >
        maxWidth
    ) {
      wrap = wordwrap(
        initialIndent + namesStringLen + typeSeparatorStringLen,
        maxWidth,
      )
      return (
        namesString + '' + typeSeparatorString + wrap(type).replace(/^\s+/, '')
      )
    } else {
      return (
        namesString +
        '' +
        (option.boolean ? '' : typeSeparatorString + '' + type)
      )
    }
  }
  setHelpStyleDefaults = function (helpStyle) {
    ...
    helpStyle.descriptionSeparator == null &&
      (helpStyle.descriptionSeparator = '  ')
  ...
  generateHelpForOption = function (getOption, arg$) {
    ...
    return function (optionName) {
      ...
      description =
        ...
        (option.description && sentencize(option.description))
      fullDescription =
      ...
      descriptionString = !fullDescription
        ? ''
        : maxWidth &&
            fullDescription.length - 1 - preDescription.length > maxWidth
      ...
      seperator =
        defaultString || descriptionString || exampleString
          ...
          : ''
      return (
        pre + '' + seperator + defaultString + descriptionString + exampleString
      )
    }
  }
  generateHelp = function (arg$) {
    ...
    return function (arg$) {
      ...
      x =
        optionCount > 2 ? min(preLenMean * maxPadFactor, maxPreLen) : maxPreLen
      ...
      wrapAllFull =
        optionCount > 1 &&
        fullWrapCount + partialWrapCount * 0.5 > optionCount * 0.5
      for (i$ = 0, len$ = data.length; i$ < len$; ++i$) {
        i = i$
        item = data[i$]
