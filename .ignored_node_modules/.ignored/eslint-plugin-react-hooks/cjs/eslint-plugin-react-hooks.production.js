...
var rule$1 = {
  ...
  create: function (context) {
    ...
    function recordAllUseEffectEventFunctions(scope) {
      ...
      try {
        for (
          var _c = __values(scope.references), _d = _c.next();
          !_d.done;
          _d = _c.next()
        ) {
          ...
          if (
            ...
            try {
              for (
                var _e =
                    ((e_2 = void 0), __values(reference.resolved.references)),
                  _f = _e.next();
                !_f.done;
                _f = _e.next()
              ) {
      ...
      onCodePathEnd: function (codePath, codePathNode) {
        ...
        function countPathsFromStart(segment, pathHistory) {
          ...
          if (pathList.has(segment.id)) {
            ...
            try {
              for (
                var cyclicSegments_1 = __values(cyclicSegments),
                  cyclicSegments_1_1 = cyclicSegments_1.next();
                !cyclicSegments_1_1.done;
                cyclicSegments_1_1 = cyclicSegments_1.next()
              ) {
              ...
              try {
                if (
                  cyclicSegments_1_1 &&
                  !cyclicSegments_1_1.done &&
                  (_a = cyclicSegments_1.return)
                )
                  _a.call(cyclicSegments_1)
              } finally {
          ...
          if (codePath.thrownSegments.includes(segment)) {
            ...
            try {
              for (
                var _c = __values(segment.prevSegments), _d = _c.next();
                !_d.done;
                _d = _c.next()
              ) {
        ...
        function countPathsToEnd(segment, pathHistory) {
          ...
          if (pathList.has(segment.id)) {
            ...
            try {
              for (
                var cyclicSegments_2 = __values(cyclicSegments),
                  cyclicSegments_2_1 = cyclicSegments_2.next();
                !cyclicSegments_2_1.done;
                cyclicSegments_2_1 = cyclicSegments_2.next()
              ) {
              ...
              try {
                if (
                  cyclicSegments_2_1 &&
                  !cyclicSegments_2_1.done &&
                  (_a = cyclicSegments_2.return)
                )
                  _a.call(cyclicSegments_2)
              } finally {
          ...
          if (codePath.thrownSegments.includes(segment)) {
            ...
            try {
              for (
                var _c = __values(segment.nextSegments), _d = _c.next();
                !_d.done;
                _d = _c.next()
              ) {
        ...
        function shortestPathLengthToStart(segment) {
          ...
          if (segment.prevSegments.length === 0) {
            ...
            try {
              for (
                var _b = __values(segment.prevSegments), _c = _b.next();
                !_c.done;
                _c = _b.next()
              ) {
        ...
        try {
          for (
            var _d = __values(codePath.finalSegments), _e = _d.next();
            !_e.done;
            _e = _d.next()
          ) {
        ...
        try {
          ...
          // if not.
          for (
            var reactHooksMap_1 = __values(reactHooksMap),
              reactHooksMap_1_1 = reactHooksMap_1.next();
            !reactHooksMap_1_1.done;
            reactHooksMap_1_1 = reactHooksMap_1.next()
          ) {
            var _f = __read(reactHooksMap_1_1.value, 2),
              segment = _f[0],
              reactHooks = _f[1]
            ...
            try {
              for (
                var reactHooks_1 = ((e_5 = void 0), __values(reactHooks)),
                  reactHooks_1_1 = reactHooks_1.next();
                !reactHooks_1_1.done;
                reactHooks_1_1 = reactHooks_1.next()
              ) {
    ...
    function visitFunctionWithDependencies(
      ...
      function isStableKnownHookValue(resolved) {
        ...
        if (name === 'useRef' && id.type === 'Identifier') {
          ...
          try {
            for (
              var _d = __values(resolved.references), _e = _d.next();
              !_e.done;
              _e = _d.next()
            ) {
              var ref = _e.value
          ...
          if (
            ...
            if (id.elements[1] === resolved.identifiers[0]) {
              if (name === 'useState') {
                ...
                try {
                  for (
                    var references_2 = __values(references),
                      references_2_1 = references_2.next();
                    !references_2_1.done;
                    references_2_1 = references_2.next()
                  ) {
                  ...
                  try {
                    if (
                      references_2_1 &&
                      !references_2_1.done &&
                      (_b = references_2.return)
                    )
                      _b.call(references_2)
                  } finally {
                    if (e_5) throw e_5.error
                  }
                }
              ...
              if (name === 'useState') {
                ...
                try {
                  for (
                    var references_3 = __values(references),
                      references_3_1 = references_3.next();
                    !references_3_1.done;
                    references_3_1 = references_3.next()
                  ) {
                  ...
                  try {
                    if (
                      references_3_1 &&
                      !references_3_1.done &&
                      (_c = references_3.return)
                    )
                      _c.call(references_3)
                  } finally {
                    if (e_6) throw e_6.error
                  }
                }
      ...
      function isFunctionWithoutCapturedValues(resolved) {
        ...
        try {
          for (
            var childScopes_1 = __values(childScopes),
              childScopes_1_1 = childScopes_1.next();
            !childScopes_1_1.done;
            childScopes_1_1 = childScopes_1.next()
          ) {
          ...
          try {
            if (
              childScopes_1_1 &&
              !childScopes_1_1.done &&
              (_a = childScopes_1.return)
            )
              _a.call(childScopes_1)
          } finally {
            if (e_7) throw e_7.error
          }
        }
        ...
        try {
          ...
          for (
            var _c = __values(fnScope.through), _d = _c.next();
            !_d.done;
            _d = _c.next()
          ) {
            var ref = _d.value
      ...
      function gatherDependenciesRecursively(currentScope) {
        ...
        try {
          for (
            var _h = __values(currentScope.references), _j = _h.next();
            !_j.done;
            _j = _h.next()
          ) {
            ...
            if (
              ...
              (((_c = dependencyNode.parent) === null || _c === void 0
                ? void 0
                : _c.type) === 'MemberExpression' ||
                ((_d = dependencyNode.parent) === null || _d === void 0
                  ? void 0
                  : _d.type) === 'OptionalMemberExpression') &&
            ...
            if (
              ((_e = dependencyNode.parent) === null || _e === void 0
                ? void 0
                : _e.type) === 'TSTypeQuery' ||
              ((_f = dependencyNode.parent) === null || _f === void 0
                ? void 0
                : _f.type) === 'TSTypeReference'
            ) {
              continue
            }
            ...
            if (!dependencies.has(dependency)) {
              ...
              ;(_g = dependencies.get(dependency)) === null || _g === void 0
                ? void 0
                : _g.references.push(reference)
            }
          }
        } catch (e_9_1) {
          e_9 = { error: e_9_1 }
        ...
        try {
          for (
            var _k = __values(currentScope.childScopes), _l = _k.next();
            !_l.done;
            _l = _k.next()
          ) {
      ...
      currentRefsInEffectCleanup.forEach(function (_a, dependency) {
        ...
        var reference = _a.reference,
          dependencyNode = _a.dependencyNode
        var references =
          ((_c = reference.resolved) === null || _c === void 0
            ? void 0
            : _c.references) || []
        ...
        try {
          for (
            var references_4 = __values(references),
              references_4_1 = references_4.next();
            !references_4_1.done;
            references_4_1 = references_4.next()
          ) {
            ...
            if (
              ...
              ((_d = parent.parent) === null || _d === void 0
                ? void 0
                : _d.type) === 'AssignmentExpression' &&
          ...
          try {
            if (
              references_4_1 &&
              !references_4_1.done &&
              (_b = references_4.return)
            )
              _b.call(references_4)
          } finally {
          ...
          reportProblem({
            ...
            message:
              'React Hook '
                ...
                .concat(setStateInsideEffectWithoutDeps_1, "'. ") +
            ...
            suggest: [
              {
                ...
                fix: function (fixer) {
                  return fixer.insertTextAfter(
                    node,
                    ', ['.concat(suggestedDependencies_1.join(', '), ']'),
                  )
                },
              },
            ],
      ...
      var _d = collectRecommendations({
        ...
        suggestedDependencies = _d.suggestedDependencies,
        unnecessaryDependencies = _d.unnecessaryDependencies,
        missingDependencies = _d.missingDependencies,
        duplicateDependencies = _d.duplicateDependencies
      ...
      if (problemCount === 0) {
        ...
        constructions.forEach(function (_a) {
          var _b
          var construction = _a.construction,
            isUsedOutsideOfHook = _a.isUsedOutsideOfHook,
            depType = _a.depType
          ...
          var message =
            ...
            ''
              ...
              .concat(
                (_b = declaredDependenciesNode.loc) === null || _b === void 0
                  ? void 0
                  : _b.start.line,
                ') ',
              ) +
        ...
        missingDependencies.forEach(function (missingDep) {
          ...
          if (
            ...
            ((_b =
              usedDep === null || usedDep === void 0
                ? void 0
                : usedDep.references[0]) === null || _b === void 0
              ? void 0
              : _b.resolved) !== topScopeRef
          ) {
            return
          }
          ...
          try {
            for (
              var _c = __values(usedDep.references), _d = _c.next();
              !_d.done;
              _d = _c.next()
            ) {
              var reference = _d.value
      ...
      if (!extraWarning && missingDependencies.size > 0) {
        ...
        try {
          for (
            var missingDependencies_1 = __values(missingDependencies),
              missingDependencies_1_1 = missingDependencies_1.next();
            !missingDependencies_1_1.done;
            missingDependencies_1_1 = missingDependencies_1.next()
          ) {
            ...
            try {
              for (
                var references_1 = ((e_3 = void 0), __values(references)),
          ...
          try {
            if (
              missingDependencies_1_1 &&
              !missingDependencies_1_1.done &&
              (_b = missingDependencies_1.return)
            )
      ...
      reportProblem({
        node: declaredDependenciesNode,
        message:
          'React Hook '.concat(getSourceCode().getText(reactiveHook), ' has ') +
        ...
        suggest: [
          {
            ...
            fix: function (fixer) {
              ...
              return fixer.replaceText(
                declaredDependenciesNode,
                '['.concat(suggestedDeps.map(formatDependency).join(', '), ']'),
              )
            },
          },
        ],
...
function collectRecommendations(_a) {
  var dependencies = _a.dependencies,
    declaredDependencies = _a.declaredDependencies,
    stableDependencies = _a.stableDependencies,
    externalDependencies = _a.externalDependencies,
    isEffect = _a.isEffect
...
function scanForConstructions(_a) {
  var declaredDependencies = _a.declaredDependencies,
    declaredDependenciesNode = _a.declaredDependenciesNode,
    componentScope = _a.componentScope,
    scope = _a.scope
  ...
  function isUsedOutsideOfHook(ref) {
    ...
    try {
      for (
        var _b = __values(ref.references), _c = _b.next();
        !_c.done;
        _c = _b.next()
      ) {
...
function fastFindReferenceWithParent(start, target) {
  ...
  while (queue.length) {
    ...
    try {
      for (
        var _b = ((e_16 = void 0), __values(Object.entries(item))),
          _c = _b.next();
        !_c.done;
        _c = _b.next()
      ) {
