...
type NodeListType<N, K extends keyof N> =
  N[K] extends Array<infer P> ? (P extends Node ? P : never) : never
...
export class NodePath<T = Node> {
   ...
   */
  replaceWithMultiple<Nodes extends Node | readonly Node[] | [Node, ...Node[]]>(
    nodes: Nodes,
  ): NodePaths<Nodes>
  ...
  get<P extends string>(
    path: P,
    context?: boolean | TraversalContext,
  ): NodePathResult<ImplGetRecursive<T, P>>
...
// dprint-ignore
type ImplGetByKey<T, K extends string> = T extends readonly unknown[]
  ? ImplGetOfArray<T, K>
  : K extends keyof T
    ? T[K]
    : K extends `${infer N extends number}`
...
// dprint-ignore
type ImplGetRecursive<T, K extends string> = K extends `${infer L}.${infer R}`
